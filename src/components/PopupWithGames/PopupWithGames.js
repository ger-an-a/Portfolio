  ...
  return (
    <Popup closePopup={props.closePopup} isVisible={props.isVisible} theme={props.theme} children={
      <>
        ...
        <p className="popup__about">Правила игры: необходимо поймать как можно больше котиков за ограниченное время. С каждой поимкой котик становится быстрее! Таймер и текущий счёт отображаются в верхней части поля.</p>
